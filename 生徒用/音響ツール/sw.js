...
// 【例外】id:'05'（あこがれの夏）のみ、Base64埋め込みデータと実ファイルの内容が
// 一致しないことが判明したため、安全のため今回はBase64埋め込みのまま残している。
// そのためあこがれの夏.mp3の実ファイルはPRECACHE_URLSに含めていない
// （HTML本体に内蔵済みのBase64データで再生されるため個別キャッシュが不要）。
//
...
const CACHE_NAME = 'sound-tool-cache-v9';
const PRECACHE_URLS = [
  './音響再生ツール.html',
  './manifest.json',
  './icons/icon-192.png',
